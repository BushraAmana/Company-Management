...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if(!empty($_POST['address'])){
      ...
      if(!empty($_POST['pass']) && ($_POST['pass'])==($_POST['c_pwd'])){
        ...
        $sqlUers = "select A_id from admin where username = '$username'";
        ...
        if($rowCount > 0){
          ...
          $sql = "INSERT INTO admin (name, email, username, password, Gender, phone, Address) VALUES ('$name', '$email', '$username', '$uPassToDb', '$gender', '$phone', '$address')";
