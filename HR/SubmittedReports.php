...
<body>
	...
	<div class="content_area">
		...
		<div class="content_right">
			<h2 style="color:green">All Submitted reports are here</h2>
      <?php
      ...
      {
      ?>
      <P style="color:green"><a download="<?php echo $files[$a] ?>" href="../uploads/<?php echo $files[$a] ?>" style="color:#000080"><?php echo $files[$a] ?></a> </p>
      <?php
      }
      ?>
