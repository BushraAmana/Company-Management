...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if(!empty($_POST['address'])){
      ...
      if(!empty($_POST['pass']) && ($_POST['pass'])==($_POST['c_pwd'])){
        ...
        $sqlUers = "select e_id from employees where username = '$username'";
        ...
        if($rowCount > 0){
          ...
          $sql = "INSERT INTO employees (name, email, username, password, Gender, phone, Address) VALUES ('$name', '$email', '$username', '$uPassToDb', '$gender', '$phone', '$address')";
...
<body>
	...
	<div class="content_area">
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        		<h2 style="color:yellow">New Employee ACCOUNT REGISTRATION</h2>
  			<table align="center">
  				<tr>
